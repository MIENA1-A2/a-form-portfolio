...
export default function HomeContent(){
 ...
 return <main id="main-content" className="frame-home">
  ...
  <section className="frame-intro" id="top"><div className="frame-kicker">A / FORM — INDEPENDENT DESIGNER <span>©2026</span></div><motion.div {...enter} className="frame-intro-copy"><span>VISUAL SYSTEMS FOR</span><h1>IDEAS<br/>IN MOTION.</h1><p>Brand identity, art direction and digital experiences shaped with clarity, tension and a little unexpected energy.</p></motion.div><div className="frame-coordinates">01°17′N<br/>103°51′E</div></section>
